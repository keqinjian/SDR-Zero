...
【现场必改】
---------------------------------------------------------------------------
  pluto_uri（TX，≠ RX）、target_freq、target_sens、tx_atten
  默认示例：红方一级 432.2 MHz / Sens=2.8194 / atten=10（干扰约 -10 dBm）

---------------------------------------------------------------------------
【端口】UDP 12347 | XMLRPC 8083
---------------------------------------------------------------------------
"""
...
class tx_radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        ##################################################
        # 【改成你的「发射」Pluto IP；RX 常见 192.168.2.1 → TX 用 .2】
        self.pluto_uri = pluto_uri = 'ip:192.168.2.2'
