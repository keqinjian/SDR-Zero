...
class tx_radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_source_0 = iio.pluto_source('ip:192.168.3.1', target_freq, 1000000, 1000000, 32768, True, True, True, 'manual', 40, '', True)
    ...
    def set_target_freq(self, target_freq):
        ...
        self.iio_pluto_source_0.set_params(self.target_freq, 1000000, 1000000, True, True, True, 'manual', 40, '', True)
